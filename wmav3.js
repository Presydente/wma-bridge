...
const my = {
  ...
  // Add syncTradePay as a method to listen for the event
  syncTradePay() {
    // Add event listener for SyncTradePay only when this method is called
...
// Set up general event listeners and attach `my` to the global `window` object
...
// Function to start syncing trade pay (e.g., call this in your Flutter code when payment starts)
