...
my.initiate({
  syncTradePayData: {
    success: function(data) {
      ...
      const auxNo = JSON.parse(data).auxNo;
      console.log("Dispatching syncTradePayDataSuccess with detail:", auxNo);
      window.dispatchEvent(new CustomEvent('syncTradePayDataSuccess', { detail: { auxNo: auxNo } }));
    },
    fail: function(error) {
