...
my.initiate({
  syncTradePayData: {
    success: function(data) {
      ...
      // Dispatch the event with the parsed data (or raw data if parsing failed)
      console.log("Dispatching syncTradePayDataSuccess with detail:", parsedData);
      window.dispatchEvent(new CustomEvent('syncTradePayDataSuccess', { detail: parsedData }));
    },
    fail: function(error) {
